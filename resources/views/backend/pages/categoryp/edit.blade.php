						...
						<div class="card border-top border-0 border-4 border-info">
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<hr/>
                                    <form action="{{ route('updatecategoryp',$cat->id) }}" method="POST">
                                        @csrf
									<div class="row mb-3">
										<label for="inputEnterYourBrand" class="col-sm-3 col-form-label">Enter Your Brand Name</label>
										<div class="col-sm-9">
											<input type="text" name="name" value="{{ $cat->name }}" class="form-control" id="inputEnterYourBrand" placeholder="Enter Brand Name">
										</div>
									</div>
									<div class="row mb-3">
										<label for="inputPhoneNo2" class="col-sm-3 col-form-label">Brand Description</label>
										<div class="col-sm-9">
											<input type="text" name="des" value="{{ $cat->des }}" class="form-control" id="inputPhoneNo2" placeholder="Brand Description">
										</div>
									</div>
									<div class="row mb-3">
										<label for="inputEmailAddress2" class="col-sm-3 col-form-label">Price</label>
										<div class="col-sm-9">
											<input type="text" name="price" value="{{ $cat->price }}" class="form-control" id="inputEmailAddress2" placeholder="Price">
										</div>
									</div>
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<select name="status" class="form-control" id="inputConfirmPassword2">
                                                ...
                                                <option value="2" @if ($cat->status==2) selected @endif >Inactive</option>
                                            </select>
										</div>
									</div>
