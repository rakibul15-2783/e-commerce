							...
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<input type="text" name="pname" class="form-control" id="inputEnterYourName" placeholder="Enter Product Name">
										</div>
									</div>
									<div class="row mb-3">
										<label for="inputPhoneNo2" class="col-sm-3 col-form-label">Product Description</label>
										<div class="col-sm-9">
											<input type="text" name="pdes" class="form-control" id="inputPhoneNo2" placeholder="Product Description">
										</div>
									</div>
									<div class="row mb-3">
