							...
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<input type="text" name="bname" class="form-control" id="inputEnterYourName" placeholder="Enter Brand Name">
										</div>
									</div>
									<div class="row mb-3">
										<label for="inputPhoneNo2" class="col-sm-3 col-form-label">Brand Description</label>
										<div class="col-sm-9">
											<input type="text" name="bdes" class="form-control" id="inputPhoneNo2" placeholder="Brand Description">
										</div>
									</div>
									<div class="row mb-3">
