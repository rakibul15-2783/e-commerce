						...
						<div class="card border-top border-0 border-4 border-info">
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<hr/>
                                    <form action="{{ route('storebrandtwo') }}" method="POST" enctype="multipart/form-data">
                                       @csrf
									<div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
										...
										<div class="col-sm-9">
											<input type="text" name="status" value="" class="form-control" id="status" placeholder="Status">
